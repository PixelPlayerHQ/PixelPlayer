...
import com.theveloper.pixelplay.data.backup.module.AiContextBackupHandler
...
object BackupModule {
    ...
    fun provideModuleHandlers(
        ...
        aiContextHandler: AiContextBackupHandler
        ...
        return mapOf(
            ...
            BackupSection.AI_CONTEXT to aiContextHandler
        )
    }
}
